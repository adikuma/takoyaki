...
It brings multiple projects, split panes, git worktree tasks, Claude Code hooks, review tools, a browser companion, and editor actions into one desktop app.
...
- **Session persistence**
- **Socket RPC**
- **Active-workspace terminal mounting**
